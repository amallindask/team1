<div id="label-page"><h3>Laporan Transaksi</h3></div>
<div id="content">
	
	<p id="tombol-tambah-container"><a href="index.php?p=laporan-transaksi-input" class="tombol">Input Laporan</a>
	<a target="_blank" href="pages/cetak-laporantransaksi.php"><img src="print.png" height="50px" height="50px"></a>
	...
	<table id="tabel-tampil">
		...
		<tr>
			...
			<td>
				<div class="tombol-opsi-container"><a href="index.php?p=laporan-transaksi-edit&id=<?php echo $r_tampil_transaksi['idtransaksi'];?>" class="tombol">Edit</a></div>
