...
?>
<div id="label-page"><h3>Edit Data Transaksi Peminjaman</h3></div>
<div id="content">
	...
	<table id="tabel-input">
		...
		<tr>
			...
			<td class="isian-formulir"><input type="date" name="tgl_pinjam" value="<?php echo $r_tampil_transaksi['tgl_pinjam']; ?>" class="isian-formulir isian-formulir-border"></td>
		</tr>
		<tr>
