<div id="label-page">
	<h3>Tampil Data Peminjaman</h3>
</div>
<div id="content">

	<p id="tombol-tambah-container"><a href="index.php?p=transaksi-peminjaman-input" class="tombol">Peminjaman</a>
		<a target="_blank" href="cetak/cetak_tr_pinjam.php"><img src="print.png" height="50px" height="50px"></a>
	...
	<table id="tabel-tampil">
		...
		?>
				<tr>
					...
					<td>
						<div class="tombol-opsi-container"><a href="index.php?p=transaksi-peminjaman-edit&id=<?php echo $r_tampil_transaksi['idtransaksi']; ?>" class="tombol">Edit</a></div>
						<div class="tombol-opsi-container"><a href="proses/transaksi-peminjaman-hapus.php?id=<?php echo $r_tampil_transaksi['idtransaksi']; ?>" onclick="return confirm ('Apakah Anda Yakin Akan Menghapus Data Ini?')" class="tombol">Hapus</a></div>
					</td>
				</tr>
		<?php $nomor++;
			}
